export const GENERATOR_CONFIG = {
    ...
    'wandcave': { color: 0xff006C42, hasStuff: false, wangFile: './data/wang_tiles/wand.png', optional: true, name: "Magical Temple" },
    ...
    'the_end': { color: 0xff3C0F0A, hasStuff: false, wangFile: './data/wang_tiles/the_end.png', optional: true, name: "The Work (Hell)" },
